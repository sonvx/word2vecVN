...
- Download any dictionary and put it into ./data/ (Note: ./data/vnex.model.bin is a super tiny model that was created for testing purpose only).
    ...
    - Trained on Le at al.'s data: https://drive.google.com/open?id=0B1GKSX6YCHXlMTVZNkFEYzRyd1E, window_size = 2: https://drive.google.com/open?id=1LV9z1RXkEg0niuC15jcW2JeeYDilXiiC
